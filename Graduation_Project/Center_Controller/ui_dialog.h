...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        pushButton_f1 = new QPushButton(groupBox);
        ...
        pushButton_f2 = new QPushButton(groupBox);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        pushButton_yes->setText(QApplication::translate("Dialog", "\347\241\256\350\256\244", 0, QApplication::UnicodeUTF8));
