...
const QMetaObjectExtraData Rx_thread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Rx_thread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Rx_thread,
      qt_meta_data_Rx_thread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Rx_thread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Rx_thread))
...
// SIGNAL 0
void Rx_thread::Rx_flag(QString _t1)
{
