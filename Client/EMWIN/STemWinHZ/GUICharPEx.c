...
static void GUI_GetDataFromMemory(const GUI_FONT_PROP GUI_UNI_PTR *pProp, U16P c)
{
    ...
    else                                                                          
    {
		...
		{
			case 12:
				SPI_Flash_Read(GUI_FontDataBuf,foffset+ftinfo.f12addr,csize);
				break;
			case 16:
				SPI_Flash_Read(GUI_FontDataBuf,foffset+ftinfo.f16addr,csize);
				break;
			case 24:
				SPI_Flash_Read(GUI_FontDataBuf,foffset+ftinfo.f24addr,csize);
				break;	
		} 
	}   	
}
